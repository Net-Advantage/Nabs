...
& "$env:UserProfile/.nuget/packages/reportgenerator/5.3.0/tools/net8.0/ReportGenerator.exe" -reports:"**/TestResults/*/coverage.cobertura.xml" -targetdir:"coveragereport"
